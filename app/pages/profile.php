            ...
            <div class="profile-details-wrapper">
                ...
                <div class="profile-meta">
                    <span class="badge role-badge">
                        ...
                        <?= ($user['role'] == 'writer' ? 'كاتب مبدع' : 'قارئ نهم') ?>
                    </span>
                    <span class="badge join-badge">
                        <i class="fa-regular fa-calendar"></i> انضم في <?= $joinDate ?>
                    </span>
                </div>
    ...
    <main class="profile-main">
        <div class="profile-tabs-wrapper">
            <ul class="profile-tabs" id="profileTabs">
                <li class="tab-item active" data-tab="reading-now"><i class="fa-solid fa-book-open"></i> أقرأ حالياً</li>
                <li class="tab-item" data-tab="favorites"><i class="fa-solid fa-heart"></i> المفضلة</li>
                <li class="tab-item" data-tab="my-list"><i class="fa-solid fa-bookmark"></i> قائمتي</li>
                <?php if ($user['role'] == 'writer'): ?>
                    <li class="tab-item" data-tab="my-works"><i class="fa-solid fa-pen-nib"></i> أعمالي</li>
                <?php endif; ?>
                <?php if ($user['role'] == 'user'): ?>
                    <li class="tab-item" data-tab="writer-request"><i class="fa-solid fa-feather"></i> كن كاتباً</li>
                <?php endif; ?>
                <li class="tab-item" data-tab="settings"><i class="fa-solid fa-gear"></i> إعدادات الحساب</li>
            </ul>
        </div>
                ...
                <div class="tab-content" id="tab-writer-request">
                    ...
                    <div class="settings-form" style="text-align: center; padding: 40px 20px;">
                        <?php if ($user_data['writer_request_status'] === 'pending'): ?>
                            <i class="fa-solid fa-clock-rotate-left" style="font-size: 4rem; color: #D8A43A; margin-bottom: 20px;"></i>
                            <h3 style="color: #3A2418; margin-bottom: 15px;">طلبك قيد المراجعة</h3>
                            <p style="color: #7A695D; font-size: 1.1rem;">لقد قمنا باستلام طلبك للإنضمام ككاتب في المنصة. يرجى الانتظار حتى تقوم الإدارة بمراجعة الطلب والموافقة عليه.</p>
                        <?php elseif ($user_data['writer_request_status'] === 'rejected'): ?>
                            <i class="fa-solid fa-circle-xmark" style="font-size: 4rem; color: #e57373; margin-bottom: 20px;"></i>
                            <h3 style="color: #3A2418; margin-bottom: 15px;">تم رفض الطلب</h3>
                            <p style="color: #7A695D; font-size: 1.1rem; margin-bottom: 25px;">عذراً، لم تتم الموافقة على طلبك للإنضمام ككاتب هذه المرة. يمكنك المحاولة وتقديم الطلب مرة أخرى.</p>
                            <form method="post">
                                <button type="submit" name="request_writer" class="nav-btn filled submit-btn">تقديم الطلب مجدداً</button>
                            </form>
                        <?php else: ?>
                            <i class="fa-solid fa-feather-pointed" style="font-size: 4rem; color: #D8A43A; margin-bottom: 20px;"></i>
                            <h3 style="color: #3A2418; margin-bottom: 15px;">هل لديك موهبة الكتابة؟</h3>
                            <p style="color: #7A695D; font-size: 1.1rem; margin-bottom: 25px;">انضم إلى مجتمعنا وشارك إبداعاتك ورواياتك مع آلاف القراء على المنصة. قدم طلبك الآن ليتم مراجعته من قبل الإدارة، وابدأ رحلتك ككاتب مبدع!</p>
                            <form method="post">
                ...
                <form class="settings-form" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="settings-section">
                        ...
                        <div class="form-group image-upload-group">
                            <p>اختر صورة جديدة من جهازك</p>
                            <label for="profileImageInput" class="image-upload-label"><i class="fa-solid fa-cloud-upload-alt"></i> استعراض</label>
                        </div>
                    </div>
