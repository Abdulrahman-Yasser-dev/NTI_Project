...
<body>
        ...
        <form method="POST" action="add_novel" enctype="multipart/form-data" id="novelForm" novalidate>
            ...
            <div class="field">
                ...
                <div class="file-input-wrapper">
                    ...
                    <span class="file-label" id="fileNameDisplay">اختر صورة...</span>
                    <span class="file-btn">تصفح</span>
                </div>
            ...
            <div class="field">
                ...
                <input type="text" name="title" id="title" maxlength="100" required placeholder="أدخل اسم الرواية">
            ...
            <div class="field">
                ...
                <textarea name="description" id="description" maxlength="2000" rows="6" required placeholder="أكتب نبذة عن الرواية..."></textarea>
            ...
            <div class="field">
                ...
                <div class="dropdown" id="catDropdown">
                    <div class="dropdown-toggle" id="catToggle">
                        ...
                        <span class="arrow" style="font-size:0.8rem;">▾</span>
                    </div>
    ...
    <!-- ============================================================
    JAVASCRIPT - Link to the separated JS file
    ============================================================ -->
